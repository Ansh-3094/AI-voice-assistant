...
import { HiOutlineSparkles , HiOutlineMicrophone , HiOutlineCode , HiOutlineLightningBolt} from "react-icons/hi";
                        ...
                        <div className="relative">
                            ...
                            <div className="mb-8">
                                ...
                                <p className="mt-3 max-w-xl text-sm leading-6 text-slate-600 sm:text-base">
                                    Access your dashboard, manage your assistant, and continue building fast AI voice experiences.
                                </p>
                            </div>

                            <button type="button" onClick={handleLogin} disabled={loading} className="flex w-full items-center justify-center gap-3 rounded-2xl border border-slate-200 bg-white px-4 py-3 text-sm font-semibold text-slate-700 shadow-sm transition hover:border-slate-300 hover:bg-slate-50 disabled:cursor-not-allowed disabled:opacity-60 sm:text-base">
                            ...
                            <form className="space-y-4">
                                ...
                                <p className="text-center text-sm text-slate-600">
                                    ...
                                    <a href="#" className="font-semibold text-purple-700 transition hover:text-purple-800">
                                        Create one
                                    </a>
                                </p>
                            </form>
                    ...
                    <aside className="order-1 lg:order-2">
                        <div className="rounded-4xl bg-slate-950 p-8 text-white shadow-[0_30px_80px_rgba(15,23,42,0.28)] sm:p-10">
                            ...
                            <p className="mt-4 max-w-xl text-sm leading-6 text-slate-300 sm:text-base">
                                This layout keeps your sign-in flow focused while still showing the value of your AI voice platform.
                            </p>
