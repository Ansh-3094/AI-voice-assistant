...
import { hasRazorpayCredentials, instance } from "../Configs/razorpay.js";
...
export const createorder = async (req, res) => {
  try {
    ...
    if (!hasRazorpayCredentials || !instance) {
      return res.status(503).json({
        success: false,
        message: "Razorpay is not configured on this local setup",
      });
    }
